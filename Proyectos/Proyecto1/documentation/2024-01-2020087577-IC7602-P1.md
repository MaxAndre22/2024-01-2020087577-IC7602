...
Ahora que tenemos nuestro proxy funcionando, debemos realizar las pruebas de carga que deberan redirigir los request a los servidores indicados en el config.json
